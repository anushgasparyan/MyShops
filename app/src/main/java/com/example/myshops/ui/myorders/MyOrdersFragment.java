package com.example.myshops.ui.myorders;
...
import com.example.myshops.CustomAdapterOrder;
...
public class MyOrdersFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.my_orders_fragment, container, false);
                                ...
                                for (DataSnapshot child : snapshot.getChildren()) {
                                    ...
                                    handler.postDelayed(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            Query query1 = databaseReference1.orderByChild("id").equalTo(order.getProductID());
                                            query1.addValueEventListener(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    ...
                                                    customAdapter = new CustomAdapterOrder(getContext(), in, email);
