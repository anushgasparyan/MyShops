    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        if (email.isEmpty()) {
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    in.clear();
                    DatabaseReference databaseReference2 = FirebaseDatabase.getInstance().getReference("wishlist");
                                ...
                                for (DataSnapshot child : snapshot.getChildren()) {
                                    ...
                                    handler.postDelayed(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            Query query1 = databaseReference1.orderByChild("id").equalTo(wishlist.getProductID());
